...
public static class Demo_HelperMethods
{
    public static void menuRadiusInit(ref GameObject menuLevel1, ref GameObject menuLevel2, ref GameObject menuLevel3, Demo_MenuControl.MenuStructure _menuStructure, Demo_MenuControl.MenuSize menuSize)
    {
        float degreeToMeter = 0.174537f;
        string[] orientationFourStr = { "North", "East", "South", "West" };
        string[] orientationSixStr = { "1", "2", "3", "4", "5", "6" };
        if (_menuStructure == Demo_MenuControl.MenuStructure.S_4x4x4)
        {
        ...
        else if (_menuStructure == Demo_MenuControl.MenuStructure.S_6x6x6)
        {
    ...
    public static void menuItemLabelDistanceInit(ref GameObject menuLevel1, ref GameObject menuLevel2, ref GameObject menuLevel3, Demo_MenuControl.MenuStructure _menuStructure, Demo_MenuControl.MenuSize menuSize, float labelToAnchorDistance)
    {
        float degreeToMeter = 0.174537f;
    ...
    public static void visualAnchorPositionInit(ref GameObject latticeVisualAnchor, Demo_MenuControl.MenuStructure _menuStructure, Demo_MenuControl.MenuSize menuSize)
    {
        float degreeToMeter = 0.174537f;
    ...
    public static void progressiveUnfoldingEffectApply(ref GameObject latticeVisualAnchor, Demo_MenuControl.ProgressiveUnfoldingEffect _progressiveUnfoldingEffect)
    {
        if (_progressiveUnfoldingEffect == Demo_MenuControl.ProgressiveUnfoldingEffect.ProgressiveLatticeMenu)
        {
            for (int i = 0; i < latticeVisualAnchor.transform.childCount; i++)
